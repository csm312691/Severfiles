...
function requestDelivery()
    ...
    SetTimeout(2000, function()
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            message = "Here is all info about the delivery, <br>Items: <br> "..amount.."x "..QBCore.Shared.Items[waitingDelivery["itemData"]["item"]]["label"].."<br><br> make sure to be on time.",
            button = {
                enabled = true,
