...
Config['CoreSettings'] = {
    ["ESX"] = {
        ...
        ["ProgressBarScriptName"] = "cr-taskbar", -- progress bar script name link in esx_readme.md
    },
    ["QBCORE"] = {
        ["Version"] = "new", -- new = using export | old = using events
        ["Export"] = exports['qb-core']:GetCoreObject(), -- uncomment this if using new CRCore version
        ["Trigger"] = "QBCore:GetObject",
        ["HasItem"] = "QBCore:HasItem", -- Important [ Your trigger for checking has item, default is CORENAME:HasItem ] 

    }, 
    ["NPBASE"] = {
        ["Name"] = "unwind-fw", -- this will be used in server side to call player module
        ["ProgressBarScriptName"] = "cr-taskbar", -- progress bar script name link in np_readme.md
        ["HasItem"] = "cr-inventory", -- Important [ Your normal export for checking has item, default is yourservername:inventory ] 
    }
}
...
Config['Utils'] = {
    ["Rewards"] = {
        ...
        ["RewardMoneyAmount"] = "20000", -- this will be the amount the player recieves when he finish the mission (no need to config if you are using an item as a reward)
        ["RewardAccount"] = "cash", -- this can be only ywo values (no need to config if you are using an item as a reward)
    },
    ["Contracts"] = {
        ["TimeBetweenContracts"] = 7200000, -- Time in (ms) between contract creations
    ...
    ["Notifications"] = {
        ...
        ["UiStillLoadingMsg"] = "Please wait 3 seconds while the nui is loading.", 
        ["SuccessHack"] = "Success." ,
        ["NoMissionDetected"] = "No ongoing mission detected.",
    },
    ["Commands"] = {
        ["boosting_test"] = "", -- This Command will send you a test contract for testing purposes leave as nil to disable
        ["force_close_nui"] = "", -- This Command will close the nui if it glitches leave as nil to disable
        ["get_vehicle_class"] = "", -- This Command will print (F8) the vehicle class of the one ur sitting in
    },
    ["Laptop"] = {
        ...
        ["ShowNotifyOnlyIfHasItem"] = true, -- Only officers that has pixellaptop will get a notify and see the blip
    },
}
